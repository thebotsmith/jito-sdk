...
import (
	...
	block_engine_pb "github.com/Prophet-Solutions/jito-sdk/pb/block_engine"
...
func NewRelayer(
	...
	blockEngineRelayerClient := block_engine_pb.NewBlockEngineRelayerClient(conn)
...
func (r *Relayer) SubscribeAccountsOfInterest(opts ...grpc.CallOption) (
	block_engine_pb.BlockEngineRelayer_SubscribeAccountsOfInterestClient, error) {
	return r.Client.SubscribeAccountsOfInterest(
		r.AuthenticationService.GRPCCtx,
		&block_engine_pb.AccountsOfInterestRequest{},
		opts...,
	)
}
...
func (r *Relayer) OnSubscribeAccountsOfInterest(ctx context.Context) (
	...
	chAccountOfInterest := make(chan *block_engine_pb.AccountsOfInterestUpdate)
	chErr := make(chan error)
...
func (r *Relayer) SubscribeProgramsOfInterest(opts ...grpc.CallOption) (
	block_engine_pb.BlockEngineRelayer_SubscribeProgramsOfInterestClient, error) {
	return r.Client.SubscribeProgramsOfInterest(
		r.AuthenticationService.GRPCCtx,
		&block_engine_pb.ProgramsOfInterestRequest{},
		opts...,
	)
}
...
func (r *Relayer) OnSubscribeProgramsOfInterest(ctx context.Context) (
	...
	chProgramsOfInterest := make(chan *block_engine_pb.ProgramsOfInterestUpdate)
	chErr := make(chan error)
...
func (r *Relayer) StartExpiringPacketStream(opts ...grpc.CallOption) (
	block_engine_pb.BlockEngineRelayer_StartExpiringPacketStreamClient, error) {
...
func (r *Relayer) OnStartExpiringPacketStream(ctx context.Context) (
	...
	chPacket := make(chan *block_engine_pb.StartExpiringPacketStreamResponse)
	chErr := make(chan error)
