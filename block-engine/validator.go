...
func NewValidator(
	...
	blockEngineValidatorClient := block_engine_pb.NewBlockEngineValidatorClient(conn)
...
) (block_engine_pb.BlockEngineValidator_SubscribePacketsClient, error) {
	return v.Client.SubscribePackets(
		v.AuthenticationService.GRPCCtx,
		&block_engine_pb.SubscribePacketsRequest{},
		opts...,
	)
}
...
func (v *Validator) OnPacketSubscription(
	...
	chPackets := make(chan *block_engine_pb.SubscribePacketsResponse)
	chErr := make(chan error)
...
func (v *Validator) SubscribeBundles(
	opts ...grpc.CallOption,
) (block_engine_pb.BlockEngineValidator_SubscribeBundlesClient, error) {
	return v.Client.SubscribeBundles(
		v.AuthenticationService.GRPCCtx,
		&block_engine_pb.SubscribeBundlesRequest{},
		opts...,
	)
}
...
func (v *Validator) GetBlockBuilderFeeInfo(
	...
	return v.Client.GetBlockBuilderFeeInfo(
		v.AuthenticationService.GRPCCtx,
		&block_engine_pb.BlockBuilderFeeInfoRequest{},
		opts...,
	)
}
