...
func (c *relayerClient) SubscribePackets(ctx context.Context, in *SubscribePacketsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribePacketsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRelayerServer) SubscribePackets(*SubscribePacketsRequest, grpc.ServerStreamingServer[SubscribePacketsResponse]) error {
...
func _Relayer_SubscribePackets_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RelayerServer).SubscribePackets(m, &grpc.GenericServerStream[SubscribePacketsRequest, SubscribePacketsResponse]{ServerStream: stream})
}
